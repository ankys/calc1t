...
#remark[
ベルヌーイ多項式$B_n (x)$の最高次の項は$x^n$であり、定数項は$b_n$である。
]
...
$
$
B_(n+1) (x) = (n+1) integral_0^x B_n (t) dd(t)+b_(n+1)
$
が成り立つ。
]
...
$
B_(n+1) (x)
= (n+1) integral_0^x B_n (t) dd(t)+B_(n+1) (0)
= (n+1) integral_0^x B_n (t) dd(t)+b_(n+1)
$
が得られる。
]
